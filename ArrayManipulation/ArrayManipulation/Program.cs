...
namespace Arraymanipulator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                else if (command == "first")
                {
                    ...
                    int[] firstElement = FirstElement(numbers, count, parameter);
        ...
        private static int[] FirstElement(int[] numbers, int count, string parameter)
        {
            int[] result = new int[count];
        ...
        private static void Exchange(int[] numbers, int idx)
        {
            ...
            for (int rotations = 0; rotations < idx; rotations++)
            {
